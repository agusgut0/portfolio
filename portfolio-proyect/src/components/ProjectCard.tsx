        ...
        <>
            <div className="project-card">
                ...
                <div className="project-preview-wrapper">
                    <div className="project-preview" onClick={() => setIsModalOpen(true)} style={{ cursor: 'zoom-in' }}>
            ...
            {isModalOpen && createPortal(
                <div className={`gif-modal-backdrop${isClosing ? ' closing' : ''}`} onClick={closeModal}>
                    <div className="gif-modal-content" onClick={(e) => e.stopPropagation()}>
                        <img src={imageSrc} alt={title} className="gif-modal-img" />
                    </div>
                    <button className="gif-modal-close" onClick={closeModal} aria-label="Cerrar">
